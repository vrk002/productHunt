...
import { SeederCollectionReadingOptions, SeederConfig, SeederConfigWithoutDatabase } from './config';
...
export declare class Seeder {
     ...
     */
    config: SeederConfigWithoutDatabase;
    /**
     * Database connection.
     */
     ...
     */
    readCollectionsFromPath: (path: string, partialConfig?: DeepPartial<SeederCollectionReadingOptions>) => SeederCollection[];
    /**
     ...
     */
    import: (collections: SeederCollection[], partialConfig?: DeepPartial<SeederConfig>) => Promise<void>;
}
